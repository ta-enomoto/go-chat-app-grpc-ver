...
### - 技術的特徴
  ...
  - セキュリティ
    冒頭のパスワードのハッシュ化以外にも、メタ文字のエスケープによるXSS対策、プリペアドステートメントの使用によるSQLインジェクション対策など、基礎的なセキュリティ対策を行っています。
